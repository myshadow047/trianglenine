...
<form action="<?php echo current_url() ?>" method="post" class="ajaxform">
    <fieldset>
        ...
        <div>
            <label class="mandatory">Printing Type Name</label>
            <input type="text" value="<?php echo set_value('printing_type_name') ?>" name="printing_type_name" placeholder="Printing Type Name" />
        </div>
    </fieldset>
