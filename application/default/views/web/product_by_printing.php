    ...
    <div class="thumbArea">
        <div class="productThumb row animated fadeIn">
            <div class="thumb xlarge-3 large-3 medium-6 small-12 tiny-12">
                <div class="imageArea">
                    <a href="<?php echo site_url('web/printing/sablon_manual/plastisol/o-neck') ?>">
                ...
                <div class="descArea row">
                    ...
                    <h6>
                        <a href="<?php echo site_url('web/printing/sablon_manual/plastisol/o-neck') ?>">Lorem ipsum dolor sit amet, consectetur</a>
                    </h6>
                </div>
            </div>
        </div>
