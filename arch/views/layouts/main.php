                    ...
                    <div id="layout-header" class="layout-header">
                        <div class="wrapper">
                            ...
                            <div class="top-nav top-nav-right right">
                                <ul class="menu">
                                    <li class="status"><span class="system-time"><span class="trianglenine-date"></span> &#149; <span class="triangle-time"></span></span></li>
                                    <li class="user-sys">
                ...
                <div id="layout-footer" class="layout-footer">
                    <div class="wrapper">
                        <div id="footer-copyright" class="footer-copyright">
                            <p>
                                Copyright &copy; 2015 <a href="http://trianglenine.biz" target="blank">Trianglenine Clothing</a>. All rights reserved.
